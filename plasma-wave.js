// plasma-wave.js — fundo PlasmaWave (port vanilla do React Bits @react-bits/PlasmaWave)
// Shaders identicos ao upstream; troca React/useEffect por init/dispose imperativo.
import { Renderer, Camera, Transform, Program, Mesh, Geometry } from 'https://cdn.jsdelivr.net/npm/ogl@1.0.11/+esm';
...
export function initPlasmaWave(container, options = {}) {
  ...
  const uniformOffset = new Float32Array([o.xOffset, o.yOffset]);
  ...
  const program = new Program(gl, {
    ...
    uniforms: {
      ...
      uRotation: { value: (o.rotationDeg * Math.PI) / 180 },
      uFocalLength: { value: o.focalLength },
      uSpeed1: { value: o.speed1 },
      uSpeed2: { value: o.speed2 },
      uDir2: { value: o.dir2 },
      uBend1: { value: o.bend1 },
      uBend2: { value: o.bend2 },
      uColor1: { value: hexToRgb(o.colors[0]) },
      uColor2: { value: hexToRgb(o.colors[1]) },
